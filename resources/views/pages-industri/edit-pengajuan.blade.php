...
<main class="p-6 overflow-y-auto h-full">
    <div class="max-w-7xl mx-auto bg-white p-4 sm:p-6 rounded-lg shadow-md">
        <h1 class="text-xl sm:text-2xl font-bold mb-6 text-center">Edit Pengajuan</h1>
        ...
        <form id="attendanceForm" class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
                <label for="date" class="block text-sm font-medium text-gray-700">Tanggal Pengajuan</label>
                <input type="date" id="date" class="border rounded p-2 w-full mt-1" readonly value="2023-10-01">
            </div>

            <div>
                <label for="checkInTime" class="block text-sm font-medium text-gray-700">Alasan</label>
                <input type="text" id="reason" class="border rounded p-2 w-full mt-1" readonly value="Sakit">
            </div>

            <div>
                <label for="checkOutTime" class="block text-sm font-medium text-gray-700">Keterangan</label>
...
<script>
    document.getElementById('attendanceForm').addEventListener('submit', function(e) {
        ...
        // Arahkan kembali ke halaman 
        window.location.href = '/kelola-pengajuan'; 
    });
</script>
@endsection